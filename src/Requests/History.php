...
class History extends Request implements RequestInterface
{
    const URL = "/exchange/v1/history";
    ...
    {
        return self::URL . (!empty($this->queryPath) ? '?' . $this->queryPath : '?version=V3&offset=0&limit=10');
    }
